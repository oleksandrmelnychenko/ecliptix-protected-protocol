...
public static class EcliptixNativeInterop
{
    ...
    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    public static extern EcliptixErrorCode ecliptix_protocol_server_system_create(
        IntPtr identityKeys,
        out IntPtr outHandle,
        out EcliptixError outError);

    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    public static extern EcliptixErrorCode ecliptix_protocol_server_system_set_callbacks(
        IntPtr handle,
        in EcliptixCallbacks callbacks,
        out EcliptixError outError);

    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    public static extern EcliptixErrorCode ecliptix_protocol_server_system_begin_handshake(
        IntPtr handle,
        uint connectionId,
        byte exchangeType,
    ...
    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    public static extern EcliptixErrorCode ecliptix_protocol_server_system_begin_handshake_with_peer_kyber(
        IntPtr handle,
        uint connectionId,
        byte exchangeType,
    ...
    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    public static extern EcliptixErrorCode ecliptix_protocol_server_system_complete_handshake(
        IntPtr handle,
    ...
    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    public static extern EcliptixErrorCode ecliptix_protocol_server_system_complete_handshake_auto(
        IntPtr handle,
        [In] byte[] peerHandshakeMessage,
        nuint peerHandshakeMessageLength,
        out EcliptixError outError);
    ...
    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    public static extern EcliptixErrorCode ecliptix_protocol_server_system_send_message(
        IntPtr handle,
        [In] byte[] plaintext,
    ...
    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    public static extern EcliptixErrorCode ecliptix_protocol_server_system_has_connection(
        IntPtr handle,
        out bool outHasConnection,
        out EcliptixError outError);

    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    public static extern EcliptixErrorCode ecliptix_protocol_server_system_get_connection_id(
        IntPtr handle,
        out uint outConnectionId,
        out EcliptixError outError);

    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    public static extern EcliptixErrorCode ecliptix_protocol_server_system_get_selected_opk_id(
        IntPtr handle,
    ...
    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    public static extern EcliptixErrorCode ecliptix_protocol_server_system_set_kyber_secrets(
        IntPtr handle,
    ...
    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    public static extern EcliptixErrorCode ecliptix_protocol_server_system_receive_message(
        IntPtr handle,
    ...
    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    public static extern EcliptixErrorCode ecliptix_protocol_server_system_create_from_root(
        IntPtr identityKeys,
        [In] byte[] rootKey,
        nuint rootKeyLength,
        [In] byte[] peerBundle,
    ...
    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    public static extern EcliptixErrorCode ecliptix_protocol_server_system_export_state(
        IntPtr handle,
        out EcliptixBuffer outState,
        out EcliptixError outError);

    [DllImport(LibraryName, CallingConvention = CallingConvention.Cdecl)]
    public static extern EcliptixErrorCode ecliptix_protocol_server_system_import_state(
        IntPtr identityKeys,
        [In] byte[] stateBytes,
